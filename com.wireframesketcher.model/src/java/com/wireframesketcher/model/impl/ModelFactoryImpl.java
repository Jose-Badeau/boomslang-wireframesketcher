...
public class ModelFactoryImpl extends EFactoryImpl implements ModelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ModelPackage.CLICK_SUPPORT: return createClickSupport();
			case ModelPackage.TEXT_INPUT_SUPPORT: return createTextInputSupport();
			case ModelPackage.FRAME: return createFrame();
	 ...
	 * @generated
	 */
	public ClickSupport createClickSupport() {
		ClickSupportImpl clickSupport = new ClickSupportImpl();
		return clickSupport;
	}
	 ...
	 * @generated
	 */
	public TextInputSupport createTextInputSupport() {
		TextInputSupportImpl textInputSupport = new TextInputSupportImpl();
		return textInputSupport;
	}
