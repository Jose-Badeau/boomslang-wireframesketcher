 ...
 *   <li>{@link com.wireframesketcher.model.impl.VLineImpl#getSkin <em>Skin</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VLineImpl extends WidgetImpl implements VLine {
	...
	public void setSkin(URI newSkin) {
		...
		skin = newSkin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.VLINE__SKIN, oldSkin, skin));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == SkinSupport.class) {
			switch (derivedFeatureID) {
				case ModelPackage.VLINE__SKIN: return ModelPackage.SKIN_SUPPORT__SKIN;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == SkinSupport.class) {
			switch (baseFeatureID) {
				case ModelPackage.SKIN_SUPPORT__SKIN: return ModelPackage.VLINE__SKIN;
				default: return -1;
			}
		}
